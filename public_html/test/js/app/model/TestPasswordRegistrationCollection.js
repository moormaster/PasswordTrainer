...
describe("PasswordRegistrationCollection", new function() {
    beforeEach(function() {
    ...
    describe("update()", function() {
        ...
        it("should update the password hash", function() {
            ...
            assert.isOk(originalRegistration.description == registration.description, "description should not change");
            assert.isOk(originalRegistration.hash != registration.hash, "salted hash should have changed");
            assert.isOk(originalRegistration.scoreData.lastSuccessScore == registration.scoreData.lastSuccessScore, "rehash should not change scoreData");
            assert.isOk(originalRegistration.scoreData.lastSuccessTimestamp == registration.scoreData.lastSuccessTimestamp, "rehash should not change scoreData");
        });
        ...
        it("should update the description", function() {
            ...
            assert.isOk(originalRegistration.description != registration.description, "description should be changed");
            assert.isOk(originalRegistration.hash == registration.hash, "salted hash should not change");
            assert.isOk(originalRegistration.scoreData.lastSuccessScore == registration.scoreData.lastSuccessScore, "rehash should not change scoreData");
            assert.isOk(originalRegistration.scoreData.lastSuccessTimestamp == registration.scoreData.lastSuccessTimestamp, "rehash should not change scoreData");
            assert.isOk(this.passwordRegistrationCollection.get("rehash") == null, "registration should have disappeared at description slot");
        });
    });
