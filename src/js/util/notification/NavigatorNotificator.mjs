...
export class NavigatorNotificator {
  constructor() {
    ...
    if (this.Notification) this.Notification.requestPermission()
  }
  ...
  hasNotificationPermission() {
    ...
    if (this.Notification.permission != 'granted') return false
  ...
  hasVibrationPermission() {
    ...
    if (!this.navigator.vibrate) return false
