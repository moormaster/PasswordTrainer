...
;(function ($) {
  ...
  $.fn.JQPasswordRegistration = function (options) {
    ...
    if (!this.passwordCollection) this.passwordCollection = this.children('.password')
    ...
    instance.passwordCollection.each(function () {
      elemInit(this, instance)
    })
    instance.passwordRepeatCollection.each(function () {
      elemInit(this, instance)
    })

    this.passwordCollection.change(function () {
      passwordEntered(this, instance)
    })
    this.passwordRepeatCollection.change(function () {
      passwordEntered(this, instance)
    })
  }
})(jQuery)
