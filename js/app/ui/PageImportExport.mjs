...
import { JSONFormatter } from '../../util/json/JSONFormatter.mjs'

export var PageImportExport = (function ($) {
  class PageImportExport {
    ...
    init() {
      ...
      $('#pageImportExport').on('pageshow', function (e) {
        pageInstance.exportPasswordRegistrations()
      })

      $('#pageImportExport').on('change', function (e) {
