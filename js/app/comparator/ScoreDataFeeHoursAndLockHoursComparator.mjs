...
export class ScoreDataFeeHoursAndLockHoursComparator {
  constructor() {}
  ...
  compare(obj1, obj2) {
    ...
    if (leveledScore1.feeHoursPassed > leveledScore2.feeHoursPassed) return -1

    if (leveledScore1.feeHoursPassed < leveledScore2.feeHoursPassed) return 1

    // minimum lock hours first
    if (leveledScore1.lockHoursLeft < leveledScore2.lockHoursLeft) return -1
